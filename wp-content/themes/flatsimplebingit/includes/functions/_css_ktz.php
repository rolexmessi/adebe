...
function ktz_google_font_link(){
	...
	if (!is_admin()) {
		...
		if (! empty ( $getheadinggfont['font-family'] ) && ! empty ( $getbodygfont['font-family'] ) ) {
			echo "<link href='//fonts.googleapis.com/css?family=" . $getheadinggfont_arr . "|" . $getbodygfont_arr . "' rel='stylesheet' type='text/css'>";
		} elseif (! empty ( $getheadinggfont['font-family'] ) ) {
			echo "<link href='//fonts.googleapis.com/css?family=" . $getheadinggfont_arr . "|Open+Sans:light,lightitalic,regular,regularitalic,600,600italic,bold,bolditalic,800,800italic' rel='stylesheet' type='text/css'>";
		} elseif (! empty ( $getbodygfont['font-family'] ) ) {
			echo "<link href='//fonts.googleapis.com/css?family=Open+Sans:light,lightitalic,regular,regularitalic,600,600italic,bold,bolditalic,800,800italic|" . $getbodygfont_arr . "' rel='stylesheet' type='text/css'>";
		} else {
			echo "<link href='//fonts.googleapis.com/css?family=Open+Sans:light,lightitalic,regular,regularitalic,600,600italic,bold,bolditalic,800,800italic' rel='stylesheet' type='text/css'>";
		}
	}				
}
add_action( 'wp_head', 'ktz_google_font_link', 3 );
